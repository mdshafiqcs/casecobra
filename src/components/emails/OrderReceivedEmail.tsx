...
const OrderReceivedEmail: FC<OrderReceivedEmailProps> = ({shippingAddress, orderId, orderDate}) => {
      ...
      <Container style={container}>
        <Section style={message}>
          ...
          <Text style={global.text}>
            We're preparing everything for delivery and will notify you once your package has been shipped. Delivery usually takes 3-5 business days.
          </Text>
        ...
        <Section style={paddingY}>
          <Row>
            <Text style={{...footer.text, paddingTop: 30, paddingBottom: 30}}>
              Please contact us if you have any questions.(If you reply to this email won't be able to see it.)
            </Text>
          </Row>
          <Row>
            <Text style={footer.text}>
            © CaseCobra, All rights reserved.
            </Text>
          </Row>
        </Section>
