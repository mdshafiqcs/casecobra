...
const Phone: FC<PhoneProps> = ({imgSrc, className, dark= false, ...props}) => {
  return <div className={cn("relative pointer-events-none z-50 overflow-hidden", className)} {...props}>
    ...
    <div className='absolute -z-10 inset-0'>
      <img src={imgSrc} alt="overlaying phone image " className="object-cover min-w-full min-h-full pointer-events-none z-50 select-none" />
    </div>
  </div>
}
