        ...
        <div className='h-full flex items-center space-x-4'>
          {
            user ? (
              ...
              <>
                <Link href="/api/auth/register" className={buttonVariants({size: "sm", variant: "ghost", className:"!text-sm" })}>Sign up</Link>
                <Link href="/api/auth/login" className={buttonVariants({size: "sm", variant: "ghost", className:"!text-sm"  })}>Login</Link>
