...
const ThankYou: FC<ThankYouProps> = ({}) => {
  ...
  // loading state for stripe to complete the webhook call -> not yet paid
  if(data === false) {
    return <div className='w-full mt-24 flex justify-center'>
      <div className='flex flex-col items-center gap-2'>
        <Loader2 className='h-8 w-8 animate-spin text-zinc-500' />
    ...
    <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
      ...
      <div className='mt-10 border-t border-zinc-200'>
        <div className='mt-10 flex flex-auto flex-col'>
          ...
          <p className='mt-2 text-sm text-zinc-600'>We at CaseCobra believe that a phone case doesn't only need to look good but also last you for the years to come. We offer a 2 year print guarantee. If your case isn't of the highest quality, we'll replace it for free.</p>
        </div>
      </div>
